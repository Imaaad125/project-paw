...
<body class="bg-white h-screen">
    <header class="flex sticky items-center h-auto justify-between bg-[#002D62] text-white ">
        ...
        <div class="flex ">
            ...
            <a href="" class="text-white text-[18px] font-medium sm:text-[25px] hover:bg-[#CFFAEF] rounded-sm hover:text-[#1800a0] py-2 px-4 sm:px-[90px] pt-[29px] pb-[24px]">Meet Request</a>
                  </div>
        <!-- Icons -->
